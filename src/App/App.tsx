...
function App() {
    ...
    const [allChips, setAllChips] = useState(getStrukture()[strukture][0].buyIn ? 40000*players.all : 15000*players.all)
    ...
    useEffect(() => {
        ...
        setAllChips(getStrukture()[strukture][0].buyIn ? 40000*players.all + sum : 15000*players.all+sum)
    }, [players]);
