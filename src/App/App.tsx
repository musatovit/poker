...
function App() {
    ...
    const [allChips, setAllChips] = useState(getStrukture()[strukture][0].buyIn ? 40000*players.all : 25000*players.all)
    ...
    useEffect(() => {
        ...
        setAllChips(getStrukture()[strukture][0].buyIn ? 40000*players.all + sum : 25000*players.all+sum)
    }, [players]);
